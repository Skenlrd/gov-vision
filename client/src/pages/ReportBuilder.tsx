...
const REPORT_TYPES: Array<{
  ...
  },
  {
    ...
    description:
      "All anomalies detected by Isolation Forest with feature values",
  },
  {
    value: "risk",
    label: "Risk Report",
    description: "Risk scores per department from Random Forest model",
  },
];
    ...
    <div className="p-6 max-w-3xl space-y-8">
      ...
      <div className="space-y-4 border-t pt-6">
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-gray-800 hover:bg-gray-900 disabled:bg-gray-400 text-white py-3 rounded-xl font-semibold text-sm transition-colors flex items-center justify-center gap-2"
        >
          {loading ? (
            <>
